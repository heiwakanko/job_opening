                ...
                Container(
                  ...
                  child: TextAndIconsInCard(
                    lines: [
                      ...
                      const TextSpan(
                          text:
                              "とはいえ、人間は完璧ではありません。人はそれぞれ(^◇^;),,,なところもあるわけです。なので、ぜひ、それ以上の貴方の持っている良いところを面接で教えてください。未経験でも全く心配ありません、経験豊かな先輩たちが教えてくれます。やる気持ちさえあれば、初月から総支給50万も実現します。弊社のドライバーさんたちは年齢も様々、前職歴も様々、国籍も様々、勤務スタイルも様々です。人生長いのですから自分に合ったスタイルを見つけてください。寮も完備、食堂も完備、入社祝い金もあります。ぜひ、(株)平和観光のタクシードライバー求人にご応募ください。\n\n弊社の運行エリアは'埼玉県A地区県南中央交通圏'(川口市, さいたま市, 鴻巣市, 上尾市, 蕨市, 戸田市, 桶川市, 北本市及び北足立郡伊奈町)になります",
